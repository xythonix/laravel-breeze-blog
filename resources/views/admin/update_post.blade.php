    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-4 overflow-hidden shadow-sm sm:rounded-lg">
                <form id="add_form" action="{{route('post.update_post',[$post->id,$post->cat_id])}}" enctype="multipart/form-data" method="POST" class="row">
                    @csrf
                    ...
                    <div class="col-lg-6 p-3">
                        ...
                        <textarea value="" placeholder="Post Description" style="resize: none" name="description" id="" class="tinymce-editor border-gray-300 w-full focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" cols="30" rows="3">{{$post->description}}</textarea>
